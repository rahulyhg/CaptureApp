...
angular.module("pageslide-directive", []).directive("pageslide", [function () {
    return {
        ...
        link: function (a, b, c) {
            ...
            var f = {};
            f.side = a.psSide || "right", f.speed = a.psSpeed || "0.5", f.size = a.psSize || "300px", f.zindex = 1e3, f.className = a.psClass || "ng-pageslide", f.cloak = a.psCloak && "false" == a.psCloak.toLowerCase() ? !1 : !0, f.squeeze = Boolean(a.psSqueeze) || !1, f.push = Boolean(a.psPush) || !1, b.addClass(f.className);
            var g = null,
                h = null,
                i = document.body;
